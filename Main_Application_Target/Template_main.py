...
NavigationLayout:
    ...
    BoxLayout:
        ...
        Toolbar:
            id: toolbar
            title: 'KivyMD | CodexLink Learning Target Framework'
            md_bg_color: get_color_from_hex(colors['Red']['700'])
...
class KitchenSink(App):
    ...
    title = "KivyMD Kitchen Sink | CodexLink Workable Framework"
